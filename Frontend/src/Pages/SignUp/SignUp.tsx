...
const SignUp = () => {
  ...
  setErrors(missingFields);
    ...
    if (
      ...
      await axios
        .post("http://localhost:8065/api/user/register", newUser)
        .then(async() => {
          alert("New User Added");
          await axios .post("http://localhost:8065/api/user/registermail", {user_name,
          userEmail:email,
          "text":"Succussfully register to the FASCO Shoppping web siter",
